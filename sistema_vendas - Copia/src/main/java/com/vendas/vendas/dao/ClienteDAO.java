...
public class ClienteDAO {
    ...
    public static ArrayList<Cliente> listar()throws SQLException {
        ...
        while(rs.next()){
            ...
            try {
                dataNascimento = LocalDate.parse(data); // tenta yyyy-MM-dd
            } catch (Exception e) {
            ...
            String dataCadastroStr = rs.getString("DATA_DE_CADASTRO");
            LocalDate dataDeCadastro;

            try {
                dataDeCadastro = LocalDate.parse(dataCadastroStr); // yyyy-MM-dd
            } catch (Exception e) {
                DateTimeFormatter formatter =
                        DateTimeFormatter.ofPattern("dd-MM-yyyy");
                dataDeCadastro = LocalDate.parse(dataCadastroStr, formatter);
            }
